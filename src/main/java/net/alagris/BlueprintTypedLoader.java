...
public class BlueprintTypedLoader<Cargo, Cnfg extends GlobalConfig> extends BlueprintLoader
    ...
    public <UnitTest> BlueprintTest<Cargo, CargoBuilder<Cargo>, UnitTest> loadTest(File testFile,
            Class<CargoBuilder<Cargo>> builder, Class<UnitTest> unit) throws JsonProcessingException, IOException {
        return BlueprintTest.load(testFile, builder, cargo, unit);
    }

    public <UnitTest> BlueprintTest<Cargo, CargoBuilder<Cargo>, UnitTest> loadTest(String testJson,
            Class<CargoBuilder<Cargo>> builder, Class<UnitTest> unit) throws JsonProcessingException, IOException {
        return BlueprintTest.load(testJson, builder, cargo, unit);
    }

    public <UnitTest> BlueprintTest<Cargo, CargoBuilder<Cargo>, UnitTest> loadTest(InputStream testStream,
            Class<CargoBuilder<Cargo>> builder, Class<UnitTest> unit) throws JsonProcessingException, IOException {
        return BlueprintTest.load(testStream, builder, cargo, unit);
    }
